							...
							<div class="col-xl-12">
								<div class="card">
									...
									<div class="card-footer border-0 m-auto pt-3">
										<a href="javascript:void(0);" class="btn btn-outline-primary m-auto dlab-load-more" id="FeaturedCompanies" rel="/cakephp/demo/jobick-admin/ajax-featuredcompanies">View more</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-xl-12">
								<div class="card">
									...
									<div class="card-footer border-0 text-center">
										<a href="javascript:void(0);" class="btn btn-outline-primary m-auto dlab-load-more" id="RecentActivity" rel="/cakephp/demo/jobick-admin/ajax-recentactivity">View more</a>
									</div>
								</div>
							</div>
							<div class="col-xl-12">
