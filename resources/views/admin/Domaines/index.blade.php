...
@section('title', 'Liste desdépartements')
...
<div class="modal-dialog modal-lg">
	...
	<div class="d-flex align-items-center mb-4 flex-wrap">
		<h3 class="me-auto">Liste des domaines</h3>
		<div>
			<a href="{{ route('domaine.create') }}" class="btn btn-primary me-3"><i class="fas fa-plus me-2"></i>Ajouter un nouveau domaine</a>
				...
				<table class="table display mb-4 dataTablesCard job-table table-responsive-xl card-table" id="example5">
					...
					<tbody>
                        @foreach ($domaines as $key => $domaine )
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>{{ $domaine->departement->nom_departement }}</td>
                                <td>{{ $domaine->nom_domaine }}</td>
                                <td>
                                    <div class="action-buttons d-flex justify-content-end">
                                        <a href="{{ route('domaine.edit', $domaine) }}" class="btn btn-secondary light mr-2">
