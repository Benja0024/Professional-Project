...
@section('title', 'Ajout d\'un domaine')
...
<!--**********************************
	...
	<div class="d-flex align-items-center mb-4">
		<h3 class="mb-0 me-auto">Nouveau domaine</h3>
		<div>
                    ...
                    <form action="{{ route('domaine.store')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <select class="form-control @error('departement_id') is-invalid @enderror" name="departement_id" id="departement_id">
                                    ...
                                    @foreach ($departements as $key => $departement )
                                        <option value="{{ $key }}" {{ old('departement_id') == $key ? 'selected' : '' }}>{{ $departement }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control @error('nom_domaine') is-invalid @enderror" name="nom_domaine" id="nom_domaine" placeholder="Nom domaine" aria-label="name" value="{{ old('nom_domaine') }}">
                                @error('nom_domaine')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
