...
<!--**********************************
	...
	<div class="d-flex align-items-center mb-4">
		<h3 class="mb-0 me-auto">Modification domaine</h3>
		<div>
                    ...
                    <form action="{{ route('domaine.update', $domaine)}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control @error('nom_domaine') is-invalid @enderror" name="nom_domaine" id="nom_domaine" placeholder="Nom domaine" aria-label="name" value="{{ $domaine->nom_domaine }}">
                                @error('nom_domaine')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
