...
***********************************-->
    ...
    ***********************************-->
    <!-- Required vendors -->
	<script>
    	var csrfToken = 'u7zeYcQ+4CFpWXmx9XWrdCcwojmWHyjzM4nV6CTij2Rv0Aj7qEbHZT/NqRAYA9n3A1vBD2Ih0tkl4iHZ9UHTUrY2LNbUmFOAFAnECvcmEJYBsODaHYfuU1nhbZ2cJPQGD/TLIS016pM2OKM2ABjqvA=='; 
    </script>
			<script>var asset_base_url = 'index.html';</script>
			<script>
   ...
   <script>	function JobickCarousel()
	{
