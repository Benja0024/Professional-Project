...
@section('title', 'Modification d\'un département')
        ...
        <div class="collapse navbar-collapse justify-content-between">
            <div class="header-left">
                <div class="dashboard_bar">
                 Modification département                    </div>
                <div class="nav-item d-flex align-items-center">
                    <form action="https://jobick.dexignlab.com/cakephp/demo">
                        <div class="input-group search-area">
                            <input type="text" class="form-control" placeholder="Search" id="validationCustom01">
                    ...
                    <form action="{{ route('departement.update', $departement)}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control @error('nom_departement') is-invalid @enderror" name="nom_departement" id="nom_departement" aria-label="name" value="{{ $departement->nom_departement }}">
