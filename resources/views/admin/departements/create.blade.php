                    ...
                    <form action="{{ route('departement.store')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control @error('nom_departement') is-invalid @enderror" name="nom_departement" id="nom_departement" placeholder="Nom département" aria-label="name" value="{{ old('nom_departement') }}">
