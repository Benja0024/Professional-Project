...
<div class="modal-dialog modal-lg">
	...
	<div class="d-flex align-items-center mb-4 flex-wrap">
		...
		<div>
			<a href="{{ route('departement.create') }}" class="btn btn-primary me-3"><i class="fas fa-plus me-2"></i>Ajouter un nouveau département</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons d-flex justify-content-end">
                                        <a href="{{ route('departement.edit', $departement) }}" class="btn btn-secondary light mr-2">
