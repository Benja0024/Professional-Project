                ...
                <div class="nav-item d-flex align-items-center">
                    ...
                    <div class="plus-icon">
                        <a href="javascript:void(0);" data-bs-toggle="modal"
                            data-bs-target=".bd-example-modal-lg1"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
            </div>
                ...
                <li class="nav-item dropdown header-profile">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="email-inbox.html" class="dropdown-item ai-icon">
                            <svg id="icon-inbox1" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18"
                                height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path
...
<!--**********************************
	...
	<div class="d-flex align-items-center mb-4">
		<h3 class="mb-0 me-auto">Modification modérateur</h3>
		<div>
                    ...
                    <form action="{{ route('moderateur.update', $moderateur)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <input type="text"   id="validationCustom01" class="form-control @error('nom') is-invalid @enderror" value="{{ $moderateur->nom }}" name="nom" placeholder="Entrer votre nom" id="nom" >
                                @error('nom')
                            ...
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <input type="text"   id="validationCustom02" class="form-control @error('prenom') is-invalid @enderror" name="prenom" placeholder="Entrer votre prenom" id="prenom" value="{{ $moderateur->prenom }}">
                                @error('prenom')
                                    <span class="invalid-feedback" role="alert">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <input type="text"   id="validationCustom03" class="form-control @error('adresse') is-invalid @enderror" name="adresse" placeholder="Entrer votre adresse" id="adresse" value="{{ $moderateur->adresse }}">
                                @error('adresse')
                                    <span class="invalid-feedback" role="alert">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <input type="phone"  id="validationCustom04"  class="form-control @error('telephone') is-invalid @enderror" name="telephone" placeholder="hello@example.com" id="telephone" value="{{ $moderateur->telephone }}">
                                @error('telephone')
                                    <span class="invalid-feedback" role="alert">
                                        {{$message}}
                                    </span>
                                ...
                                <div class="col-xl-6  col-md-6 mb-4">
                                    ...
                                    <input type="email"  id="validationCustom05"  class="form-control @error('email') is-invalid @enderror" name="email" placeholder="hello@example.com" id="email" value="{{ $moderateur->email }}">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            {{$message}}
                                        </span>
                                ...
                                <div class="col-xl-6  col-md-6 mb-4">
                                    <div class="author-media">
                                        <img src="{{asset('storage/' . $moderateur->avatar)}}" class="rounded-circle img-fluid" width="100" height="100" alt="">
