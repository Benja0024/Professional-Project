...
@section('title', 'Liste des modérateurs')
...
<div class="modal-dialog modal-lg">
	...
	<div class="d-flex align-items-center mb-4 flex-wrap">
		<h3 class="me-auto">Liste des moderateurs</h3>
		<div>
			<a href="{{ route('moderateur.create') }}" class="btn btn-primary me-3"><i class="fas fa-plus me-2"></i>Ajouter un nouveau moderateur</a>
					...
					<tbody>
                        @foreach ($moderateurs as $key => $moderateur )
                            <tr>
                                ...
                                <td>{{ $moderateur->adresse}}</td>
                                <td>{{ $moderateur->email}}</td>
                                <td>{{ $moderateur->telephone}}</td>
                                <td>
                                    <img src="{{asset('storage/' . $moderateur->avatar)}}" class="rounded-circle img-fluid" width="50" height="50" alt="">
                                </td>
                                <td>
                                    <div class="action-buttons d-flex justify-content-end">
                                        <a href="{{ route('moderateur.edit', $moderateur) }}" class="btn btn-secondary light mr-2">
                                        ...
                                        <form action="{{ route('moderateur.destroy', $moderateur) }}" method="POST">
