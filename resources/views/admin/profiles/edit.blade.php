						...
						<div class="p-5">
							<div class="author-profile">
								<div class="author-media">
								    <form action="{{ route('change.avatar', $admin) }}" enctype="multipart/form-data" method="post" id="imageForm">
                                        @csrf
                                        @method('PUT')
                                        <img src="{{ asset('storage/' . $admin->avatar) }}" alt="">
                                        <div class="upload-link" title="" data-bs-toggle="tooltip" data-placement="right"
                                            data-original-title="update">
                                            <input type="file" class="update-flie" name="avatar" id="imageInput">
		...
		<div class="col-xl-9 col-lg-8">
			<div class="card  card-bx m-b30">
				<div class="card-header">
                    <h4 class="card-title text-uppercase">Edition du compte</h4>
                </div>
                <form action="{{ route('profile.update', $admin)}}" method="post" class="profile-form needs-validation" novalidate>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 m-b30">
                                ...
                                <input type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" id="nom" value="{{ $admin->nom }}">
                                @error('nom')
                            ...
                            <div class="col-sm-6 m-b30">
                                ...
                                <input type="text" class="form-control @error('adresse') is-invalid @enderror" name="adresse" id="adresse" value="{{ $admin->adresse }}">
                                @error('adresse')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-sm-6 m-b30">
                                ...
                                <input type="text" class="form-control @error('telephone') is-invalid @enderror" name="telephone" id="telephone" value="{{ $admin->telephone }}">
                                @error('telephone')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{route('editPassword.edit', $admin)}}" class="text-primary btn-link text-end">Voulez-vous modifier votre mot de passe ?</a>
                    </div>
                </form>
			</div>
		</div>
...
<!-- Mirrored from jobick.dexignlab.com/cakephp/demo/jobick-admin/edit-profile by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 11 Dec 2023 15:17:12 GMT -->
</html>