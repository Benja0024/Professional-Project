    ...
    <div class="card mb-0 h-auto">
        <div class="card-body">
            ...
            <form action="{{ route('editPassword.update', $admin) }}" method="post">
                ...
                <div class="mb-sm-4 mb-3 position-relative">
                    <label class="form-label" for="dlab-password">Nouveau mot de passe</label>
                    <input type="password" id="dlab-password" class="form-control @error('new_password') is-invalid @enderror" name="new_password" required>
                    <span class="show-pass eye">
                        <i class="fa fa-eye-slash"></i>
                        <i class="fa fa-eye"></i>
                    </span>
                ...
                <div class="mb-sm-4 mb-3 position-relative">
                    <label class="form-label" for="dlab-password">Confirmer le mot de passe</label>
                    <input type="password" id="dlab-password" class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password" required>
                    <span class="show-pass eye">
                        <i class="fa fa-eye-slash"></i>
                        <i class="fa fa-eye"></i>
                    </span>
